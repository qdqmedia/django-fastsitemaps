...
setup(
    ...
    long_description=("Drop-in replacement for django.contrib.sitemaps that gives you fast, "
                      "streaming sitemaps that consume minimal memory (O^1 instead of O^n) "
                      "and minimal server response time on huge data sets."),
